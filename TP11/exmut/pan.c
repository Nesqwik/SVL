...
char *procname[] = {
   ...
   "exclusion_mutuelle",
   "lache_la_ressource",
   "si_occupe_la_ressource_alors_variable_prise",
   "un_prendra_la_ressource",
   ":np_:",
	0
};
...
int Btypes[] = {
   ...
   4,	/* proc2 */
   2,	/* :init: */
   1,	/* exclusion_mutuelle */
   1,	/* lache_la_ressource */
   1,	/* si_occupe_la_ressource_alors_variable_prise */
   1,	/* un_prendra_la_ressource */
   0	/* :np_: */
};
...
{	int j, h = now._nr_pr;
...
#ifndef NOCLAIM
	case 8:	/* claim select */
		spin_c_typ[0] = 6; /* un_prendra_la_ressource */
		((P8 *)pptr(h))->c_cur[0] = 3;
		reached6[3]=1;
		spin_c_typ[1] = 5; /* si_occupe_la_ressource_alors_variable_prise */
		((P8 *)pptr(h))->c_cur[1] = 6;
		reached5[6]=1;
		spin_c_typ[2] = 4; /* lache_la_ressource */
		((P8 *)pptr(h))->c_cur[2] = 5;
		reached4[5]=1;
		spin_c_typ[3] = 3; /* exclusion_mutuelle */
		((P8 *)pptr(h))->c_cur[3] = 6;
		reached3[6]=1;
		((P8 *)pptr(h))->_t = 3;
		((P8 *)pptr(h))->_p = 6;
		((P8 *)pptr(h))->_n = 3; /* exclusion_mutuelle */
		src_claim = src_ln3;
#ifndef BFS
		if (whichclaim == -1 && claimname == NULL)
			printf("0: Claim exclusion_mutuelle (3), from state 6\n");
#endif
		if (whichclaim != -1)
	...
	case 7:	/* np_ */
		...
		accpstate[7][1] = 1;
		break;
	case 6:	/* un_prendra_la_ressource */
		((P6 *)pptr(h))->_t = 6;
		((P6 *)pptr(h))->_p = 3;
#ifdef HAS_PRIORITY
...
#endif
		break;
	case 5:	/* si_occupe_la_ressource_alors_variable_prise */
		((P5 *)pptr(h))->_t = 5;
		((P5 *)pptr(h))->_p = 6;
#ifdef HAS_PRIORITY
...
iniglobals(int calling_pid)
{
		...
		now.ressource2 = 0;
#ifdef VAR_RANGES
		logval("libre", now.libre);
		logval("ressource1", now.ressource1);
		logval("ressource2", now.ressource2);
#endif
}
...
{	/* int i; */
	printf("global vars:\n");
	printf("	bit    libre:	%d\n", now.libre);
	printf("	bit    ressource1:	%d\n", now.ressource1);
	printf("	bit    ressource2:	%d\n", now.ressource2);
}
void
