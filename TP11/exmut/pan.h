...
#define _nstates6	7	/* un_prendra_la_ressource */
#define minseq6	56
#define maxseq6	61
#define _endstate6	6

#define _nstates5	11	/* si_occupe_la_ressource_alors_variable_prise */
#define minseq5	46
#define maxseq5	55
#define _endstate5	10

#define _nstates4	14	/* lache_la_ressource */
#define minseq4	33
#define maxseq4	45
#define _endstate4	13

#define _nstates3	11	/* exclusion_mutuelle */
#define minseq3	23
#define maxseq3	32
...
#define _nstates1	11	/* proc2 */
#define minseq1	10
#define maxseq1	19
#define _endstate1	10

#define _nstates0	11	/* proc1 */
#define minseq0	0
#define maxseq0	9
...
typedef struct P6 { /* un_prendra_la_ressource */
...
typedef struct P5 { /* si_occupe_la_ressource_alors_variable_prise */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* lache_la_ressource */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P3 { /* exclusion_mutuelle */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#endif
	unsigned libre : 1;
	unsigned ressource1 : 1;
	unsigned ressource2 : 1;
#ifdef TRIX
