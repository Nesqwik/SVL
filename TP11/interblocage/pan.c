...
/*** From source: blocage_double.pml ***/
...
int Btypes[] = {
   4,	/* proc */
   4,	/* proc_debloque_par_2 */
   4,	/* proc_debloque_par_3 */
   2,	/* :init: */
   0	/* :np_: */
};
