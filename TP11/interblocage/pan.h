...
#define PanSource	"blocage_double.pml"
...
#define _nstates2	3	/* proc_debloque_par_3 */
#define minseq2	7
#define maxseq2	8
#define _endstate2	2

#define _nstates1	3	/* proc_debloque_par_2 */
#define minseq1	5
#define maxseq1	6
#define _endstate1	2

#define _nstates0	6	/* proc */
#define minseq0	0
#define maxseq0	4
#define _endstate0	5
...
#define Pproc_debloque_par_3	((P2 *)this)
typedef struct P2 { /* proc_debloque_par_3 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 4; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc_debloque_par_2	((P1 *)this)
typedef struct P1 { /* proc_debloque_par_2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 4; /* state    */
#ifdef HAS_PRIORITY
