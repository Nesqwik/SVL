...
{	int j, h = now._nr_pr;
	...
	case 8:	/* claim select */
		...
		((P8 *)pptr(h))->c_cur[1] = 6;
		reached5[6]=1;
		spin_c_typ[2] = 4; /* a_non_etatactif_infini */
		((P8 *)pptr(h))->c_cur[2] = 5;
		reached4[5]=1;
...
{	/* int i; */
	...
	printf("	mtype  etatA:	%d\n", now.etatA);
	printf("	mtype  etatB:	%d\n", now.etatB);
	printf("	mtype  lock:	%d\n", now.lock);
}
void
