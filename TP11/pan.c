...
char *procname[] = {
   ...
   "procBas",
   ":init:",
   "acces_exclusion_mutuelle",
   "a_non_etatHautctif_infini",
   "a_actif_implique_verrou_ferme",
   "a_en_attente_suivi_obligatoirement_etat_actif",
   ":np_:",
	0
};
...
int Btypes[] = {
   ...
   4,	/* procBas */
   2,	/* :init: */
   1,	/* acces_exclusion_mutuelle */
   1,	/* a_non_etatHautctif_infini */
   1,	/* a_actif_implique_verrou_ferme */
   1,	/* a_en_attente_suivi_obligatoirement_etat_actif */
   0	/* :np_: */
};
...
{	int j, h = now._nr_pr;
...
#ifndef NOCLAIM
	case 8:	/* claim select */
		spin_c_typ[0] = 6; /* a_en_attente_suivi_obligatoirement_etat_actif */
		((P8 *)pptr(h))->c_cur[0] = 6;
		reached6[6]=1;
		spin_c_typ[1] = 5; /* a_actif_implique_verrou_ferme */
		((P8 *)pptr(h))->c_cur[1] = 6;
		reached5[6]=1;
		spin_c_typ[2] = 4; /* a_non_etatHautctif_infini */
		((P8 *)pptr(h))->c_cur[2] = 5;
		reached4[5]=1;
		spin_c_typ[3] = 3; /* acces_exclusion_mutuelle */
		((P8 *)pptr(h))->c_cur[3] = 6;
		reached3[6]=1;
		((P8 *)pptr(h))->_t = 3;
		((P8 *)pptr(h))->_p = 6;
		((P8 *)pptr(h))->_n = 3; /* acces_exclusion_mutuelle */
		src_claim = src_ln3;
#ifndef BFS
		if (whichclaim == -1 && claimname == NULL)
			printf("0: Claim acces_exclusion_mutuelle (3), from state 6\n");
#endif
		if (whichclaim != -1)
	...
	case 7:	/* np_ */
		...
		accpstate[7][1] = 1;
		break;
	case 6:	/* a_en_attente_suivi_obligatoirement_etat_actif */
		((P6 *)pptr(h))->_t = 6;
		((P6 *)pptr(h))->_p = 6;
#ifdef HAS_PRIORITY
...
#endif
		break;
	case 5:	/* a_actif_implique_verrou_ferme */
		((P5 *)pptr(h))->_t = 5;
		((P5 *)pptr(h))->_p = 6;
#ifdef HAS_PRIORITY
...
#endif
		break;
	case 4:	/* a_non_etatHautctif_infini */
		((P4 *)pptr(h))->_t = 4;
		((P4 *)pptr(h))->_p = 5;
#ifdef HAS_PRIORITY
...
#endif
		break;
	case 3:	/* acces_exclusion_mutuelle */
		((P3 *)pptr(h))->_t = 3;
		((P3 *)pptr(h))->_p = 6;
#ifdef HAS_PRIORITY
...
{	/* int i; */
	printf("global vars:\n");
	printf("	mtype  libre:	5\n");
	printf("	mtype  occupe:	4\n");
	printf("	mtype  inactif:	3\n");
	printf("	mtype  enAttente:	2\n");
	printf("	mtype  actif:	1\n");
	printf("	mtype  etatHaut:	%d\n", now.etatHaut);
	printf("	mtype  etatBas:	%d\n", now.etatBas);
	printf("	mtype  lock:	%d\n", now.lock);
}
void
...
{
	switch (x) {
	case 1: Printf("actif"); break;
	case 2: Printf("enAttente"); break;
	case 3: Printf("inactif"); break;
	case 4: Printf("occupe"); break;
	case 5: Printf("libre"); break;
	default: Printf("%d", x);
	}
}
void
