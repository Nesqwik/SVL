...
#define _nstates6	11	/* a_en_attente_suivi_obligatoirement_etat_actif */
#define minseq6	58
#define maxseq6	67
#define _endstate6	10

#define _nstates5	11	/* a_actif_implique_verrou_ferme */
#define minseq5	48
#define maxseq5	57
...
#define _nstates3	11	/* acces_exclusion_mutuelle */
#define minseq3	25
#define maxseq3	34
...
typedef struct P6 { /* a_en_attente_suivi_obligatoirement_etat_actif */
...
typedef struct P5 { /* a_actif_implique_verrou_ferme */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P3 { /* acces_exclusion_mutuelle */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
