...
{	Trans *T;
	...
	/* proctype 6: a_en_attente_suivi_obligatoirement_etat_actif */

	trans[6] = (Trans **) emalloc(11*sizeof(Trans *));

	trans[6][7]	= settr(64,0,6,1,0,".(goto)", 0, 2, 0);
	T = trans[6][6] = settr(63,0,0,0,0,"DO", 0, 2, 0);
	...
	trans[6][9]	= settr(66,0,10,1,0,"(1)", 0, 2, 0);
	trans[6][10]	= settr(67,0,0,4,4,"-end-", 0, 3500, 0);

	/* proctype 5: a_actif_implique_verrou_ferme */

	trans[5] = (Trans **) emalloc(11*sizeof(Trans *));

	trans[5][7]	= settr(54,0,6,1,0,".(goto)", 0, 2, 0);
	T = trans[5][6] = settr(53,0,0,0,0,"DO", 0, 2, 0);
	...
	/* proctype 3: acces_exclusion_mutuelle */

	trans[3] = (Trans **) emalloc(11*sizeof(Trans *));

	trans[3][7]	= settr(31,0,6,1,0,".(goto)", 0, 2, 0);
	T = trans[3][6] = settr(30,0,0,0,0,"DO", 0, 2, 0);
	...
	trans[3][9]	= settr(33,0,10,1,0,"(1)", 0, 2, 0);
	trans[3][10]	= settr(34,0,0,11,11,"-end-", 0, 3500, 0);
