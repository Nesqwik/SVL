...
class TestCliqueDevisAfficheDevis(unittest.TestCase):
    ...
    def test_clique_devis_affiche_devis(self):
        ...
        self.assertEqual("/quotes", driver.find_element_by_css_selector("body p:nth-child(5) a").get_attribute("href"))
        self.assertEqual("Liste devis", driver.find_element_by_css_selector("body p:nth-child(5) a").text)
        self.assertEqual("/valid/00007", driver.find_element_by_css_selector("body form").get_attribute("action"))
